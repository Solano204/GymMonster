...
System.out.println("Keycloak URL: " + servicesUrl.getKeycloak().getUrl());
System.out.println("Keycloak Realm: " + servicesUrl.getKeycloak().getRealm());
System.out.println("Keycloak Docker Realm: " + servicesUrl.getKeycloak().getDockerReal());
System.out.println("Keycloak Username: " + servicesUrl.getKeycloak().getUsername());
System.out.println("Keycloak Password: " + servicesUrl.getKeycloak().getPassword());
System.out.println("Keycloak Client ID: " + servicesUrl.getKeycloak().getClientId());
System.out.println("Keycloak Client Secret: " + servicesUrl.getKeycloak().getClientSecret()); 
