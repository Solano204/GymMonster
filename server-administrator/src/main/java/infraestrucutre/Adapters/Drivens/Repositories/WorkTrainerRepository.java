...
public class WorkTrainerRepository implements WorkTrainerRepositoryInterface {
    ...
    public Mono<String> createClassTrainer(AllTrainer trainer) {
        return webClientBuilder.build()
                .post()
                .uri("http://localhost:8111/trainers/AD/create")
    ...
    public Mono<List<DtoSpecialtyRecived>> getAllSpecialtiesFromTrainer(String username) {
        return webClientBuilder.build()
                .get()
                .uri("http://localhost:8111/trainers/specialties/{username}", username)
                .accept(MediaType.APPLICATION_JSON)
                .retrieve()
    ...
    public Mono<String> updateTrainerAllDetailInformation(String username, DtoDetailUserReciving details) {
        return webClientBuilder.build()
                .put()
                .uri("http://localhost:8111/trainers/AD/{username}/updateBasicInformation", username)
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(details)
                .retrieve()
                .bodyToMono(String.class);
    ...
    public Mono<List<WorkClass>> getWorkClassesByTrainer(String username) {
        return webClientBuilder.build()
                .get()
                .uri("http://localhost:8111/trainers/classes/{username}", username)
                .accept(MediaType.APPLICATION_JSON)
                .retrieve()
    ...
    public Mono<String> updateTrainerPassword(String username, String oldPassword, String newPassword) {
        return webClientBuilder.build()
                .put()
                .uri("http://localhost:8111/trainers/AD/{username}/{oldPassword}/{newPassword}/updatePassword", username, oldPassword, newPassword)
                .retrieve()
                .bodyToMono(String.class);
    }
    ...
    public Mono<String> updateTrainerUsername(String oldUsername, String newUsername) {
        return webClientBuilder.build()
                .put()
                .uri("http://localhost:8111/trainers/AD/{oldUsername}/{newUsername}/updateUsername", oldUsername, newUsername)
                .retrieve()
                .bodyToMono(String.class);
    }
    ...
    public Mono<String> updateEmail(String username, String newEmail) {
        return webClientBuilder.build()
                .put()
                .uri("http://localhost:8111/trainers/AD/{username}/{newEmail}/updateEmail", username, newEmail)
                .retrieve()
                .bodyToMono(String.class);
    }
    ...
    public Mono<String> addSpecialtyToTrainer(String username, String newSpecialty) {
        return webClientBuilder.build()
                .post()
                .uri("http://localhost:8111/trainers/AD/{username}/{newSpecialty}/associateSpecialty", username, newSpecialty)
                .retrieve()
                .bodyToMono(String.class);
    }
    ...
    public Mono<String> dessociateSpecialty(String username, String specialty) {
        return webClientBuilder.build()
                .delete()
                .uri("http://localhost:8111/trainers/AD/{username}/{specialty}/dessociateSpecialty", username, specialty)
                .retrieve()
                .bodyToMono(String.class);
    }
    ...
    public Mono<String> addClassToTrainer(String username, String newClass) {
        return webClientBuilder.build()
                .post()
                .uri("http://localhost:8111/trainers/AD/{username}/{newClass}/addClass", username, newClass)
                .retrieve()
                .bodyToMono(String.class);
    }
    ...
    public Mono<String> dessociateClassToTrainer(String username, String className) {
        return webClientBuilder.build()
                .delete()
                .uri("http://localhost:8111/trainers/AD/{username}/{className}/dessociateClass", username, className)
                .retrieve()
                .bodyToMono(String.class);
    }
    ...
    public Mono<String> deleteClassTrainerByUsernameWithPassword(String username, String password) {
        return webClientBuilder.build()
                .delete()
                .uri("http://localhost:8111/trainers/AD/{username}/{password}/delete", username, password)
                .retrieve()
                .bodyToMono(String.class);
    }
}